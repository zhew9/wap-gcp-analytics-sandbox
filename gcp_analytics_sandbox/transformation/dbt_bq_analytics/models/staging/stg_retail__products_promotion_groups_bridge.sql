-- models/staging/stg_retail__promotion_groups_products.sql

with source as (
    select
        *
    from {{ source('boardgame_retail_raw', 'promotion_groups_products') }}
),
...
deduped as (
    ...
    qualify row_number() over (
        partition by promotion_group_id, product_id
