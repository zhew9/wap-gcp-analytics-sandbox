{% snapshot snapshot_retail__authors %}
...
-- date_modified and date_deleted should be the same if the source system is working properly
select
  *
from {{ ref('cln_retail__authors') }}
